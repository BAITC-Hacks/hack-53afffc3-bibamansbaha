...
> **Исторический этап завершён и заменён.** Дальнейший ремонт WSL/Brev отменён владельцем.
> Рабочее HTTPS-демо опубликовано на Vercel с Neon и GPT-5.5:
> https://ekt-assistant.vercel.app. Актуальная точка продолжения —
> [VERCEL_DEPLOYMENT_REPORT.md](VERCEL_DEPLOYMENT_REPORT.md). Инструкции Brev ниже не выполнять.

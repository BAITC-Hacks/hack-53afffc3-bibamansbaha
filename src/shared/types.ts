...
export type CartPlan = { operation:'add'|'replace'; cartRevision:number; beforeMinor:number; afterMinor:number; deltaMinor:number; addedMinor:number; repricingMinor:number; resultLines:ProposalLine[] };

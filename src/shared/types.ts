...
export type AppState = {messages:Message[];cart:Cart;proposal:Proposal|null;requestedLines?:RequestedLine[];catalog:{mode:CatalogMode;count:number;fetchedAt:string|null;partial:boolean;error?:string};model:{configured:boolean;verified:boolean;available?:boolean;reason?:string|null};csrf:string};
